...
export default function About() {
  ...
  return (
    // Background updated to #0b0b0b for section contrast
    <section id="about" className="py-32 bg-[#0b0b0b] relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          
          {/* CEO Image Container - Electric Blue Accents */}
          <motion.div 
          ...
          >
            ...
            <div className="relative aspect-[4/5] md:aspect-square rounded-[3rem] border border-white/5 bg-[#111111] overflow-hidden shadow-2xl">
               ...
               {/* Futuristic Overlay UI - Electric Blue (#3b82f6) */}
               ...
               {/* Identity Scan Animation in Electric Blue */}
               <motion.div 
                  initial={{ top: "0%" }}
                  animate={{ top: "100%" }}
          ...
          {/* Professional Narrative - Text Color Updates */}
          <motion.div 
          ...
          >
            ...
            {/* Accolade Grid - Card Background: #111111 */}
